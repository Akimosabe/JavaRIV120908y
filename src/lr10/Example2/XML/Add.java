...
public class Add {
    public void getNewMovie(String nameOfMovie, String evaluation, String year) {
        try {
            ...
            Document document = documentBuilder.parse("src/lr10/Example2/XML/XML.xml");
            ...
            StreamResult streamResult = new StreamResult(new File("src/lr10/Example2/XML/XML.xml"));
